...
async function profitsEstimated(userSettings) {
  ...
  console.log("LiveEstimatesFromMining1")
  ...
  let minMargin = .10
  console.log("BestArbitrageCurrentConditions1")
